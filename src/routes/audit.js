...
router.get('/workspaces/:id/audit', requireWorkspace({ roles: ['owner'] }), (req, res, next) => {
  try {
...
router.get('/workspaces/:id/audit/verify', requireWorkspace({ roles: ['owner'] }), (req, res, next) => {
  try {
